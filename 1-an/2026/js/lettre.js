...
const DESTINATIONS = [
  ...
  },
  {
    ...
    tips: "Un atelier guidé, juste toi et moi, des couleurs plein les mains et un souvenir qu'on gardera toujours.",
  },
  {
...
function showResult() {
  ...
  // Pré-remplir la carte avant l'overlay
  ...
  // Afficher l'overlay félicitations
  document.getElementById('congrats-name').textContent = dest.name;
  const overlay = document.getElementById('congrats-overlay');
  overlay.classList.add('visible');
  launchConfetti();

  // Après 2.8s : fermer l'overlay, afficher la carte
  setTimeout(() => {
    overlay.classList.add('hiding');
    setTimeout(() => {
      overlay.classList.remove('visible', 'hiding');
      document.getElementById('result-card').classList.add('show');
      document.getElementById('result-conclusion').style.display = 'block';
...
function launchConfetti() {
  const colors = ['#e83e8c','#ff6b9d','#ffd6e7','#c0395e','#ff9cc2','#a855f7','#f59e0b','#fb7185'];
  for (let i = 0; i < 70; i++) {
...
function resetWheel() {
  document.getElementById('result-card').classList.remove('show');
  document.getElementById('result-conclusion').style.display = 'none';
